...
function _buildPayPalDonateButton() {
    return React.createElement('div', {className: 'donateButtonContainer', dangerouslySetInnerHTML: {__html: `<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
